        ...
        <div className="relative pb-10 pt-32 md:pb-16 md:pt-40">
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <ul className="mb-6 ml-8 list-disc leading-relaxed text-gray-600">
              ...
              <li>
                ...
                handled securely through Stripe. OptiPixAI does not store any
                credit card details.
              </li>
            </ul>
          </div>
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <ul className="mb-6 ml-8 list-disc leading-relaxed text-gray-600">
              ...
              <li>
                <strong>Generated Images:</strong> Temporarily stored on Vercel
                Blob and deleted after [insert retention period, e.g., 30 days]
                or when manually removed by you.
              </li>
              <li>
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <ul className="mb-6 ml-8 list-disc leading-relaxed text-gray-600">
              <li>Authentication services (GitHub and Google) via NextAuth.</li>
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <ul className="mb-6 ml-8 list-disc leading-relaxed text-gray-600">
              <li>
                Personal information is retained as long as your account remains
                active.
              </li>
              <li>
